...
public class NewTourPanel extends UIComponent {

    private var startDate:TextField;
    private var finishDate:TextField;
 
    public function NewTourPanel(container:MovieClip) {
        super(container);
    }
    ...
    override public function setVisible(visible:Boolean):void {
        ...
        if(visible){
            ...
            startDate.text = "с " + MessageUtils.converDateToStr(Application.instance.context.getTourStartAt());
            finishDate.text = "до " + MessageUtils.converDateToStr(Application.instance.context.getTourFinishedAt());
    ...
    override protected function initComponent():void{
        ...
        startDate = TextField(container.getChildByName("startDate"));
